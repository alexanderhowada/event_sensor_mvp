...
#cap = cv2.VideoCapture("../../../Documents/test2.mp4")
#ret, image = cap.read()
#factor = 5
#width, height = image.shape[:2]

#fourcc = cv2.VideoWriter_fourcc(*'XVID')
#print cap.get(cv2.CAP_PROP_FPS), image.shape[:2]
#out = cv2.VideoWriter("../../../Documents/YOLO.avi",fourcc, int(cap.get(cv2.CAP_PROP_FPS))/factor, (width, height))
